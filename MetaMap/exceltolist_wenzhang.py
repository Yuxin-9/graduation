...
# 获取停用词
stopwords = []
file = open('C:\\Users\\asus\\Desktop\\新建文件夹\\初评价\\MetaMap\\整理\\stopwords.txt', 'r',encoding='utf-8')
for line in file:
...
copy=exceltolist_clean('C:\\Users\\asus\\Desktop\\新建文件夹\\初评价\\MetaMap\\整理\\文章初始.xlsx','python_wenzhang')
...
f.save('C:\\Users\\asus\\Desktop\\新建文件夹\\初评价\\MetaMap\\整理\\python_wenzhang_clean.xls')
print('数据录入完毕')
...
def main():
    wenzhang_words = exceltolist('C:\\Users\\asus\\Desktop\\新建文件夹\\初评价\\MetaMap\\整理\\python_wenzhang_clean.xls','sheet1',2)
    ...
    return wenzhang_words,word_id,P_t_s,P_s_d
    
wenzhang_words,word_id,P_t_s,P_s_d = main()
